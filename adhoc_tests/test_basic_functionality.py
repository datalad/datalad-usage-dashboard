...
def main():
    ...
    print(
        f"\n🎯 Organizations to exclude (threshold={EXCLUSION_THRESHOLD}): "
        f"{len(excluded_orgs)}"
    )
    ...
    print(
        f"  Percentage handled by org-specific search: "
        f"{excluded_repo_count / total_repos * 100:.1f}%"
    )
    ...
    print("The hybrid search strategy has been successfully implemented and tested.")
