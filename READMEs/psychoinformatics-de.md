## Active
| # | Repository (18) | Stars (51) | Dataset (18) | `run` (8) | `containers-run` (1) |
| --- | --- | --- | --- | --- | --- |
...
| 8 | [psychoinformatics-de/studyforrest-data-confoundsannotation](https://github.com/psychoinformatics-de/studyforrest-data-confoundsannotation) | 0 | :heavy_check_mark: | :heavy_check_mark: |  |
...
## Gone
| # | Repository (7) | Stars (4) | Dataset (6) | `run` (1) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
