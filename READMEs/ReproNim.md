# Active
| Repository (13) | Stars (287) | Dataset (7) | `run` (7) | `containers-run` |
| --- | --- | --- | --- | --- |
...
| [ReproNim/neurodocker](https://github.com/ReproNim/neurodocker) | 224 |  | :heavy_check_mark: |  |
...
# Gone
| Repository (2) | Stars (21) | Dataset (1) | `run` (1) | `containers-run` |
| --- | --- | --- | --- | --- |
