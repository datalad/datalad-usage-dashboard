## Active
| # | Repository (6) | Stars (454) | Dataset (1) | `run` (5) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
...
| 5 | [bids-standard/bids-starter-kit](https://github.com/bids-standard/bids-starter-kit) | 232 |  | :heavy_check_mark: |  |
