## Active
| # | Repository (8) | Stars (636) | Dataset (1) | `run` (7) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
...
| 3 | [bids-standard/bids-examples](https://github.com/bids-standard/bids-examples) | 148 |  | :heavy_check_mark: |  |
...
| 7 | [bids-standard/bids-starter-kit](https://github.com/bids-standard/bids-starter-kit) | 246 |  | :heavy_check_mark: |  |
