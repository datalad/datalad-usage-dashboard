## Active
| # | Repository (8) | Stars (628) | Dataset (1) | `run` (7) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
...
| 7 | [bids-standard/bids-starter-kit](https://github.com/bids-standard/bids-starter-kit) | 240 |  | :heavy_check_mark: |  |
