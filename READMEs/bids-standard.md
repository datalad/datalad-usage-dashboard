## Active
| # | Repository (6) | Stars (460) | Dataset (1) | `run` (5) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
...
| 5 | [bids-standard/bids-starter-kit](https://github.com/bids-standard/bids-starter-kit) | 236 |  | :heavy_check_mark: |  |
