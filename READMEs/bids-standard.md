## Active
| # | Repository (5) | Stars (193) | Dataset (1) | `run` (4) | `containers-run` |
| --- | --- | --- | --- | --- | --- |
...
| 3 | [bids-standard/bids-specification](https://github.com/bids-standard/bids-specification) | 185 |  | :heavy_check_mark: |  |
